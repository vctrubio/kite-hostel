...
CREATE TYPE "public"."booking_status" AS ENUM('active', 'uncomplete', 'completed');--> statement-breakpoint
...
ALTER TABLE "lesson" ADD CONSTRAINT "lesson_commission_id_fk" FOREIGN KEY ("commission_id") REFERENCES "public"."commission"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint

...
export const LESSON_STATUS_FILTERS = [
  ...
  { value: 'rest' as const, label: 'Rest', color: 'bg-yellow-100 dark:bg-yellow-900/30 text-yellow-800 dark:text-yellow-300 hover:bg-yellow-200 dark:hover:bg-yellow-900/50' },

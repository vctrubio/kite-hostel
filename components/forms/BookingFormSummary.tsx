...
export function BookingFormSummary({
  ...
  const selectedCommission = selectedTeacher?.commissions.find(
    (c) => c.id === selectedLessonCommissionId,
  );
              ...
              {dateRange.startDate && dateRange.endDate ? (
                <div className="space-y-1 text-sm text-muted-foreground">
                  ...
                  <p>
                    ...
                    {getDaysDifference(dateRange.startDate, dateRange.endDate)}{" "}
                    days
                  </p>
                </div>
              ) : (
              ...
              {selectedPackage ? (
                <div className="space-y-1 text-sm text-muted-foreground">
                  ...
                  <div className="grid grid-cols-2 gap-2 text-xs">
                    <p>
                      <span className="font-medium">Duration:</span>{" "}
                      {formatHours(selectedPackage.duration)}h
                    </p>
                    <p>
                      <span className="font-medium">Capacity:</span>{" "}
                      {selectedPackage.capacity_students}
                    </p>
                    <p>
                      <span className="font-medium">Price:</span> €
                      {selectedPackage.price_per_student}
                    </p>
                    <p>
                  ...
                  <p className="text-xs">
                    <span className="font-medium">Kites:</span>{" "}
                    {selectedPackage.capacity_kites}
                  </p>
                </div>
              ) : (
                <p className="text-sm text-muted-foreground italic">
            ...
            >
              ...
              {selectedReference ? (
                <p className="text-sm text-muted-foreground">
                  {selectedReference.teacher_name || selectedReference.note}
                </p>
              ) : (
                <p className="text-sm text-muted-foreground italic">
              ...
              {selectedTeacher && selectedCommission ? (
                <div className="space-y-1 text-sm text-muted-foreground">
                  ...
                  <p>
                    ...
                    {selectedCommission.price_per_hour.toFixed(0)}/h{" "}

      ...
      <div className="flex justify-between items-center">
        <div className="flex gap-1">
          ...
          <button
            ...
            className={`px-2 py-1 text-xs rounded hover:opacity-80 transition-opacity ${status === "completed"
        ...
        <button
          ...
          className={`p-1 rounded transition-colors duration-200 ${isCompleted && !hasReorganizationOptions

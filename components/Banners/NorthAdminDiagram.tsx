...
export function NorthAdminDiagram() {
  ...
  return (
    <div className="w-full max-w-7xl mx-auto py-16">
      <div className="relative rounded-3xl border-2 py-10 md:py-12 bg-white/80 border-cyan-400/40 dark:bg-gray-800/50 dark:border-cyan-500/30 backdrop-blur-sm shadow-2xl">
        {/* Title */}
                    ...
                    <table className="w-full">
                      ...
                      <tbody className="divide-y divide-gray-200 dark:divide-gray-700">
                        {schoolsData.map((school) => (
                          <tr
                            key={school.name}
                            className="hover:bg-white/50 dark:hover:bg-gray-800/30 transition-colors"
                          >
              ...
              <div className="hidden xl:block">
                ...
                >
                  ...
                  <text
                    ...
                    fontSize="18"
                    textAnchor="start"
                    className="font-bold fill-cyan-600 dark:fill-cyan-300"
                  >
                    ← Data Analytics
                  </text>
                  <text
                    ...
                    fontSize="18"
                    textAnchor="start"
                    className="font-mono fill-cyan-600 dark:fill-cyan-300"
                  >
                    App Usage
                  </text>
                </svg>

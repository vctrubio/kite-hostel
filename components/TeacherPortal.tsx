...
function TeacherHeader({ name, lessonsCount, eventsCount, commissionsCount }: TeacherRowProps) {
  return (
    <div className="flex justify-between items-center p-4 border-b border-border dark:border-gray-700">
      <div className="flex items-center gap-2">
        ...
        <h4 className="text-lg font-medium text-foreground dark:text-white">{name}</h4>
      </div>
      <div className="flex items-center gap-4">
        ...
        <div className="flex items-center gap-1">
          <KiteIcon className="w-4 h-4 text-purple-500" />
...
export default function TeacherPortal(){
    return (<TeacherHeader name="John Doe" lessonsCount={12} eventsCount={5} commissionsCount={3} />)
}
      ...
      <nav className="border-b border-gray-100 px-6 py-4">
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          ...
          <div className="flex items-center gap-4">
            ...
            <Link href="/" className="px-4 py-2 bg-[#0058A6] text-white rounded-lg hover:bg-[#004088] transition-colors">
              Get Started
            </Link>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="bg-gradient-to-br from-blue-50 to-cyan-50 p-8 rounded-2xl border border-blue-100">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h3 className="text-2xl font-bold text-gray-900">Whiteboard</h3>
              </div>
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center gap-3">
                  <CheckCircle className="w-5 h-5 text-green-500" />
                  <span className="text-gray-700">Quick status updates</span>
                </div>
                <div className="flex items-center gap-3">
                  <CheckCircle className="w-5 h-5 text-green-500" />
                  <span className="text-gray-700">Real-time filtering</span>
                </div>
              </div>
              <Link 
                href="/whiteboard" 
            ...
            <div className="bg-gradient-to-br from-purple-50 to-pink-50 p-8 rounded-2xl border border-purple-100">
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center gap-3">
                  <CheckCircle className="w-5 h-5 text-green-500" />
                  <span className="text-gray-700">Visual teacher layout</span>
                </div>
                <div className="flex items-center gap-3">
                  <CheckCircle className="w-5 h-5 text-green-500" />
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="bg-white p-8 rounded-2xl border border-gray-100 shadow-lg">
            <div className="flex items-center justify-center gap-2 mb-4">
              ...
              <span className="text-lg font-semibold text-gray-900">Tarifa Kite Hostel</span>
            </div>
      ...
      <footer className="border-t border-gray-100 px-6 py-8 bg-gray-50">
        <div className="max-w-7xl mx-auto text-center">
          <div className="flex items-center justify-center gap-2 mb-4">
            ...
            <span className="text-lg font-bold text-gray-900">KiteFlow</span>
          </div>
